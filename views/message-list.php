...
$query = $db->query("select * from chat where first_user_id= ".$id." or second_user_id=".$id);
    ...
    <div class="container">
        <?php if( $num > 0 ){ ?>
            <?php while ($row = mysqli_fetch_assoc($query)) { ?>
                <?php
                $users = $db->select('users',['id'=> $row['first_user_id'] == $id ? $row['second_user_id'] : $row['first_user_id'] ]);
                ...
                <div class="row">
                    ...
                    <div  class="col-md-8 pl-5 mt-5" style="font-family: cursive; font-size: 20px; font-weight: bolder;">
                        ...
                        <form id="createChat_<?php echo $user['id']?>" style="display: none" action="message.php" method="post">
